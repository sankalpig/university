...
export default function Path() {
    return (
        <div className='my-12 flex justify-center flex-col align-middle w-full'>
            <div className=''>
            ...
            <div className='flex flex-col md:flex-row mt-24 justify-center align-middle'>
                <div className='shadow-lg mx-10 overflow-hidden' style={{ width: "21rem" }}>
                    <div className=''>
                ...
                <div className='w-80 shadow-lg mx-10 overflow-hidden'>
                    <div className=''>
                        <img src={card1} />
                    </div>
                    ...
                    <div className='flex mt-3'>
                        <div className='flex'>
                            <img src={clock} />
                            <span className='text-sm w-20 mx-2 my-2 grey'>22hr 30min</span>
                        </div>
                        <div className='flex'>
                            <img src={video} />
                            <span className='text-sm w-20 mx-2 my-2 grey'>34 courses</span>
                        </div>
                        <div className='flex'>
                            <img src={download} />
                            <span className='text-sm w-20 mx-2 my-2 grey'>250 sales</span>
                        </div>
                    </div>
                    <div className='mx2 my-3'>
                        <button className='font-semibold text-gray-50 text-center rounded-xl h-12 w-100' style={{ background: "#fd4a36" }}>Apply Now</button>
                ...
                <div className='w-80 mx-10 overflow-hidden'>
                    <div className=''>
                        <img src={card2} />
                    </div>
                    <div className='my-3 mx-1'>
